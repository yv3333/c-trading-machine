...
class BybitExchange(BaseExchange):
    ...
    async def get_ticker(self, symbol: str) -> Ticker:
        try:
            ...
            logger.error(f"Error fetching ticker for {symbol} from Bybit: {e}")
            raise
    ...
    async def cancel_order(self, order_id: str, symbol: str) -> bool:
        try:
            ...
            logger.error(f"Error cancelling order {order_id} on Bybit: {e}")
            return False
    ...
    async def get_order(self, order_id: str, symbol: str) -> Order:
        try:
            ...
            logger.error(f"Error fetching order {order_id} from Bybit: {e}")
            raise
    ...
    async def get_open_orders(self, symbol: Optional[str] = None) -> List[Order]:
        try:
            ...
            logger.error(f"Error fetching open orders from Bybit: {e}")
            raise
    ...
    async def get_positions(self) -> List[Position]:
        try:
            ...
            logger.error(f"Error fetching positions from Bybit: {e}")
            raise
    ...
    async def set_leverage(self, symbol: str, leverage: int) -> bool:
        try:
            ...
            logger.error(f"Error setting leverage for {symbol} on Bybit: {e}")
            return False
    ...
    async def create_stop_loss_order(self, symbol: str, side: OrderSide, 
        ...
        try:
            ...
            logger.error(f"Error creating stop loss order on Bybit: {e}")
            raise
    ...
    async def create_take_profit_order(self, symbol: str, side: OrderSide, 
        ...
        try:
            ...
            logger.error(f"Error creating take profit order on Bybit: {e}")
            raise